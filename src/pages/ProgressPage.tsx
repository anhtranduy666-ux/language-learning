    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-baseline justify-between">
          <h2 className="text-lg font-bold text-slate-900">Level {level.level}</h2>
      ...
      <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-baseline justify-between">
          <h2 className="font-semibold text-slate-900">Khoá HSK 1</h2>
          <p className="text-sm text-slate-500">{courseCompletion(progress.completedLessonIds)}%</p>
        </div>
        <ProgressBar
      ...
      <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-baseline justify-between">
          <h2 className="font-semibold text-slate-900">Hôm nay</h2>
          <p className="text-sm text-slate-500">
              ...
              <li
                ...
                className={cn(
                  ...
                  isUnlocked
                    ...
                    : 'bg-white opacity-50 ring-slate-100',
                )}
              >
                <p aria-hidden="true" className="text-2xl">
                  {isUnlocked ? achievement.icon : '🔒'}
                </p>
                <p className="mt-1 text-xs font-semibold text-slate-800">{achievement.title}</p>
